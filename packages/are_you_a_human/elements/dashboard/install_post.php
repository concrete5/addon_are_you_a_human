...
$captchaLink = '<a href="' . URL::to('/dashboard/system/permissions/captcha/') . '" target="_blank">' . t(
        'captcha configuration') . '</a>';
...
<p><?= t(
        'Check out our %s first if you want to learn more about how to get started with the %s captcha system.',
        $docsLink,
        $ayahLink) ?></p>
